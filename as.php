        ...
        <main class="flex-1 p-8">
            ...
            <div class="grid grid-cols-3 gap-8">
                ...
                <div class="col-span-2 bg-white shadow-lg rounded-lg p-6">
                    <h2 class="text-xl font-semibold text-purple-600 mb-4">Recent Solving Problems</h2>
                    <div class="col-span-2">
                      <div class="flex space-x-4">
                        <div class="bg-white shadow-md rounded-lg p-4">
                          <img src="assets/img/background/c.jpeg" width="150px" height="150px" alt="Problem image" class="rounded mb-3 mx-auto">
                          <h3 class="font-semibold ">Problem 1</h3>
                            <p class="text-gray-600 text-sm">Short description of the problem...</p>
                      ...
                      <div class="flex justify-between mt-4 md:w-[800px]">
                          <div class="w-10 h-10 px-2 py-2 bg-gray-300 text-gray-700 rounded-full flex justify-center">
                              <img src="assets/img/background/left.png" width="20px" alt="Left Arrow Icon">
                          </div>
                          <span>Page 1 of 5</span>
                          <div class="w-10 h-10 py-2 bg-gray-300 text-gray-700 rounded-full flex justify-center">
                              <img src="assets/img/background/right.png" width="20px" alt="Right Arrow Icon">
                          </div>
                      </div>
                  </div>
                </div>
...
<div class="bg-white shadow-lg rounded-lg p-6">
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-center justify-between bg-yellow-200 rounded-lg px-4 py-2">
            <div class="flex items-center space-x-4">
                <img src="https://via.placeholder.com/40" alt="Avatar" class="w-10 h-10 rounded-full">
                <span class="font-semibold">1. Alice</span>
            </div>
            <div class="flex items-center space-x-2">
                <img src="assets/img/background/trophy-gold.png" alt="Trophy" class="w-6">
                <span class="font-semibold text-purple-600">1200 pts</span>
            </div>
        </div>
        <div class="flex items-center justify-between bg-gray-200 rounded-lg px-4 py-2">
            <div class="flex items-center space-x-4">
                <img src="https://via.placeholder.com/40" alt="Avatar" class="w-10 h-10 rounded-full">
                <span class="font-semibold">2. Bob</span>
            </div>
            <div class="flex items-center space-x-2">
                <img src="assets/img/background/trophy-silver.png" alt="Trophy" class="w-6">
                <span class="font-semibold text-purple-600">1150 pts</span>
            </div>
        </div>
        <div class="flex items-center justify-between bg-orange-200 rounded-lg px-4 py-2">
            <div class="flex items-center space-x-4">
                <img src="https://via.placeholder.com/40" alt="Avatar" class="w-10 h-10 rounded-full">
                <span class="font-semibold">3. Charlie</span>
            </div>
            <div class="flex items-center space-x-2">
                <img src="assets/img/background/trophy-bronze.png" alt="Trophy" class="w-6">
                ...
                <div class="col-span-2 bg-white shadow-lg rounded-lg p-6">
                  ...
                  <div class="grid grid-cols-3 gap-6">
                      ...
                      <div class="flex flex-col items-center space-y-4 p-4 border border-gray-300 rounded-lg">
                          <img src="https://via.placeholder.com/80" alt="Contest Image" class="rounded-lg mb-4">
                          <div>
                          ...
                          <button class="mt-4 px-6 py-2 bg-purple-400 text-white rounded-full hover:bg-purple-500">Register Now</button>
                      </div>
...
<div class="grid grid-cols-2 gap-6">
    ...
    <div class="bg-gradient-to-r from-purple-50 to-white shadow-lg rounded-lg p-6">
        <h2 class="text-2xl font-bold text-purple-600 mb-4">Problem Solving</h2>
    ...
    <div class="bg-gradient-to-r from-white to-purple-50 shadow-lg rounded-lg p-6">
        <h2 class="text-2xl font-bold text-purple-600 mb-4">Performance Stats</h2>
        <div class="space-y-4 text-gray-700">
            <div class="flex items-center justify-between">
